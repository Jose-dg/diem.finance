    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assessed_forecast_risks', to=settings.AUTH_USER_MODEL, verbose_name='evaluado por')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='forecast_risk_assessments', to=settings.AUTH_USER_MODEL, verbose_name='usuario')),
            ],
            options={
